...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 222000;
        consensus.BIP34Height = 10000000;
        consensus.BIP34Hash = uint256S("0x"); //genesis
	...
	consensus.nHeightMinDiff = 602662;
	...
	consensus.vDeployments[Consensus::DEPLOYMENT_POS].nTimeout = 1579536000;
        ...
        genesis = CreateGenesisBlock(1504469779, 248404, 0x1e0fffff, 1, 200 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbcfaed16ea9e080a182d1fcd113bf7d98dd4150027911c1277c2f6823a79594c"));
	...
	vSeeds.clear();
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0xFB)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0xFB)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        ...
        chainTxData = ChainTxData{
            ...
            1505405742, // * UNIX timestamp of last known number of transactions
            528006,  // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            6         // * estimated number of transactions per second after that timestamp
        };
    }
};
...
public:
	...
	vSeeds.clear();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,238);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,67);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,110);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0xA8)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0xA8)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, 1, 200 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
